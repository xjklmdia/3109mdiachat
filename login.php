...
if(isset($_POST['name']) && !isset($display_case)){
 ...
 if($name!=""){
  ...
  $ermsg="<h2 class='error'><a href='index.php'>Please Enter Name.</a></h2>";
 }
}elseif(isset($display_case)){
 if(!isset($ermsg)){
?>
 <h2>Name for chat!</h2>
 You must provide a name for chatting.<br/><br/>
 <form action="index.php" method="POST">
  <div>Your Name : <input name="name" placeholder="Name please"/></div>
